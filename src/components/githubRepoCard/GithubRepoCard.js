      ...
      <Fade bottom duration={2000} distance="40px">
        ...
        >
          ...
          {isCompanyProject && repo.websiteLogo && (
            <div className="company-project-logo">
              <img src={repo?.websiteLogo} alt={`${repo.name} logo`} />
            </div>
          )}
          ...
          {isCompanyProject && repo.url && repo.url !== "#" && (
            <div className="company-project-button-wrapper">
              <a
                href={repo.url}
                target="_blank"
                rel="noopener noreferrer"
                className="company-project-button"
